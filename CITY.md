...
**先比选后动工**：在会话内构思三个形态差异明显的方案（体量/风格/细节策略各不同），比选后将结论与**三角预算分配表**写进 NOTES.md 的「设计」节，再进入第 3 步。本城鼓励一栋楼投入充足 token 与 30–60 分钟施工时间——**宁细勿糙**（R11 底线：三角形 ≥ 12,000、mesh ≥ 60）。
...
| R11 | 完成度下限：三角形 ≥ 12,000 且 mesh ≥ 60（官方建筑豁免） |
