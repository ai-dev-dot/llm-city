...
export function showSidebar(
  ...
  el.innerHTML = `
    ...
    ${b.notesExcerpt ? `<div style="margin-bottom:12px;"><div style="color:var(--text-secondary);font-size:12px;margin-bottom:4px;">NOTES（摘录）</div><div style="line-height:1.8;">${escapeHtml(b.notesExcerpt).replace(/\n/g, '<br>')}</div></div>` : ''}
